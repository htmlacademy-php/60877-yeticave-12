  <?php var_dump($errors); ?><main>
    ...
    <form class="form form--add-lot container <?php  if ($errors) { echo "form--invalid";}?>" action="add.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form__container-two">
        ...
        <div class="form__item <?php  if ($errors) { echo "form__item--invalid";}?>">
      ...
      <div class="form__item form__item--wide <?php  if ($errors) { echo "form__item--invalid";}?>">
      ...
      <div class="form__container-three">
        <div class="form__item form__item--small <?php  if ($errors) { echo "form__item--invalid";}?>">
