<main>
    ...
    <form class="form container <?php if (isset($errors)) {
        echo "form--invalid";
    } ?>" action="registration.php" method="post" autocomplete="off">
      ...
      <?php if (isset($errors['repeatemail'])) {
            echo "form__item--invalid";
        } ?>">
        ...
        <div class="form__item <?php if (isset($errors['name'])) {
            ...
            <input id="name" type="text" name="name" placeholder="Введите имя"
                   value="<?php if (isset($errors['name']) && isset($_POST['name'])) {
        ...
        <div class="form__item <?php if (isset($errors['message'])) {
            ...
            <textarea id="message" name="message" placeholder="Напишите как с вами связаться"
                      value="<?php if (isset($errors['message']) && isset($_POST['message'])) {
